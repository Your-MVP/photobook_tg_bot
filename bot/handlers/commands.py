...
async def say_greeting(message: Message, dispatcher: Dispatcher):
    ...
    await message.answer(
        f"👋 Привет, я MagicMemory бот 📸\n"
        f"Я помогу тебе превратить фото — с телефона, семейных чатов и облака — в уютную фотокнигу, созданную с помощью ИИ.\n"
        f"Я всё сделаю автоматически: выберу лучшие кадры, красиво разложу страницы и предложу несколько макетов на выбор.\n"
        f"🌟 Чем больше фото — тем больше волшебных историй я смогу собрать.\n"
        f"Тебе останется только проверить результат, внести правки и отправить в печать — и через несколько дней альбом будет у тебя в руках.\n"
        f"Весь процесс со мной занимает всего несколько минут.",
    )
